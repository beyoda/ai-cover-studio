...
```json
{
  ...
  "source": "示例歌手的示例曲目",
  "input_audio": "C:\\path\\to\\repo\\workdir\\music_source\\gdstudio\\<hash>\\source.mp3",
  "provider": "gdstudio",
  "track_id": "3382908505",
...
```json
{
  ...
  "output_path": "C:\\path\\to\\repo\\outputs\\<job_id>\\cover.mp3",
  "error": null,
  "notify_status": "pending"
}
```
...
根目录（逻辑名 `JOBS_ROOT`，建议 `C:\path\to\repo\jobs\`）：
...
{
  "source": "示例歌手的示例曲目",
  "input_audio": "C:\\path\\to\\source.mp3",
  "provider": "gdstudio",
  "track_id": "3382908505",
  "voice_id": "example_voice_b",
  "pitch": 0,
...
```json
{
  ...
  "type": "completed",
  "message": "完成！\n\n🎵 示例曲目\n🎤 ExampleVoiceB\n\n文件见附件。",
  "file_path": "C:\\path\\to\\repo\\outputs\\<job_id>\\cover.mp3",
