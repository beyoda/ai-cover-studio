...
example_voice_b    →  G_16000.pth + configcos.json
```
...
{
  "version": 1,
  "models_dir": "<repo-root>\\tools\\so-vits-svc\\logs\\44k",
  ...
  "voices": [
    {
      ...
      "config": "configcos.json",
      "enabled": true,
      "aliases": ["G_16000", "example_voice_b"],
      "inference_speaker": null,
      "tags": [],
      "notes": "Independent voice asset; checkpoint G_16000 + configcos"
    },
    {
...
| 当前资产 | `example_voice_b`↔G_16000+configcos；`example_voice`↔G_27200+config1 |
